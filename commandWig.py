...
commandWig = {
    "tools" : {
        "tools import" : (["combo","--type",importableTypes],["importChoose",'--input-path'],["fName","--output-path"],opt_flag,["combo","--input-format",importableFormats])
    },
    "dada" : {
    ...
    "demux" : {
        ...
        opt_flag,["combo","--p-golay-error-correction",TrueFalse],["combo","--p-rev-comp-barcodes",FalseTrue],["combo","--p-rev-comp-mapping-barcodes",FalseTrue]),
    ...
    "phylogeny" : {
        ...
        opt_flag,["ifSpin","--p-n-threads",True,1],["ifSpin","--p-mask-max-gap-frequency",False,1.0],["ifSpin","--p-mask-min-conservation",False,0.4],["combo","--p-parttree",('False','True')]),
    ...
    "diversity" : {
        ...
        opt_flag,["combo","--p-method",('permanova', 'anosim', 'permdisp')],["combo","-p-pairwise",("False","True")],["ifSpin","--p-permutations",True,999]),
        "diversity alpha-rarefaction" : (["fChoose","--i-table"],["fChoose","--i-phylogeny"],["ifSpin","--p-max-depth",True,1],["fName","--o-visualization"],
        opt_flag,["fChoose","--i-phylogeny"],["combo","--p-metrics",metrics],["fChoose","--m-metadata-file"],["ifSpin","--p-min-depth",True,1],["ifSpin","--p-steps",True,10],["ifSpin","--p-iterations",True,10])
    },
    "feature-table" : {
        "feature-table summarize" : (["fChoose","--i-table"],["fName","--o-visualization"],
        opt_flag,["fChoose","--m-sample-metadata-file"]),
    ...
    "feature-classifier" :{
        ...
        opt_flag,["ifSpin","--p-reads-per-batch",True,0],["ifSpin","--p-n-jobs",True,1],["fName","--p-pre-dispatch"],["ifSpin","--p-confidence",False,0.7],["combo","--p-read-orientation",('auto','same','reverse-complement')])
    },
    "taxa" : {
    ...
    "emperor" : {
        ...
        opt_flag,["fName","--p-custom-axes"],["combo","--p-ignore-missing-samples",FalseTrue])
    }
}
